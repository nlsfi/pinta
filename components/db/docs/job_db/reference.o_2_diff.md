...
| ---- | ---- | ---------- |
| enforce_coverage_tile_o_2_diff_rast | CHECK | CHECK (COALESCE(st_iscoveragetile(NULL::raster, NULL::raster, 0, 0), ((mod(((st_upperleftx(rast))::numeric - (500000)::numeric), (1024)::numeric) = (0)::numeric) AND (mod(((st_upperlefty(rast))::numeric - (6570000)::numeric), (1024)::numeric) = (0)::numeric)))) |
...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 2, 'reference'::name, 'diff'::name, 'rast'::name)) |
...
| pk_o_2_diff | PRIMARY KEY | PRIMARY KEY (rid) |
| enforce_spatially_unique_o_2_diff_rast | x | EXCLUDE USING btree (((rast)::geometry) WITH =) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| pk_o_2_diff | CREATE UNIQUE INDEX pk_o_2_diff ON reference.o_2_diff USING btree (rid) |
| idx_o_2_diff_rast | CREATE INDEX idx_o_2_diff_rast ON reference.o_2_diff USING gist (st_convexhull(rast)) |
| enforce_spatially_unique_o_2_diff_rast | CREATE INDEX enforce_spatially_unique_o_2_diff_rast ON reference.o_2_diff USING btree (((rast)::geometry)) |
