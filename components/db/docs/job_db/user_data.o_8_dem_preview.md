...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| rid | bigint | nextval('user_data.o_8_dem_preview_rid_seq'::regclass) | false |  |  |  |
| rast | raster |  | false |  |  |  |
...
| ---- | ---- | ---------- |
| enforce_coverage_tile_o_8_dem_preview_rast | CHECK | CHECK (COALESCE(st_iscoveragetile(NULL::raster, NULL::raster, 0, 0), ((mod(((st_upperleftx(rast))::numeric - (500000)::numeric), (4096)::numeric) = (0)::numeric) AND (mod(((st_upperlefty(rast))::numeric - (6570000)::numeric), (4096)::numeric) = (0)::numeric)))) |
...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 8, 'user_data'::name, 'dem_preview'::name, 'rast'::name)) |
...
| pk_o_8_dem_preview | PRIMARY KEY | PRIMARY KEY (rid) |
| enforce_spatially_unique_o_8_dem_preview_rast | x | EXCLUDE USING btree (((rast)::geometry) WITH =) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| pk_o_8_dem_preview | CREATE UNIQUE INDEX pk_o_8_dem_preview ON user_data.o_8_dem_preview USING btree (rid) |
| idx_o_8_dem_preview_rast | CREATE INDEX idx_o_8_dem_preview_rast ON user_data.o_8_dem_preview USING gist (st_convexhull(rast)) |
| enforce_spatially_unique_o_8_dem_preview_rast | CREATE INDEX enforce_spatially_unique_o_8_dem_preview_rast ON user_data.o_8_dem_preview USING btree (((rast)::geometry)) |
