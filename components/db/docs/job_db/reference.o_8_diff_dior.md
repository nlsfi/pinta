...
| ---- | ---- | ---------- |
| enforce_coverage_tile_o_8_diff_dior_rast | CHECK | CHECK (COALESCE(st_iscoveragetile(NULL::raster, NULL::raster, 0, 0), ((mod(((st_upperleftx(rast))::numeric - (500000)::numeric), (4096)::numeric) = (0)::numeric) AND (mod(((st_upperlefty(rast))::numeric - (6570000)::numeric), (4096)::numeric) = (0)::numeric)))) |
...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 8, 'reference'::name, 'diff_dior'::name, 'rast'::name)) |
...
| pk_o_8_diff_dior | PRIMARY KEY | PRIMARY KEY (rid) |
| enforce_spatially_unique_o_8_diff_dior_rast | x | EXCLUDE USING btree (((rast)::geometry) WITH =) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| pk_o_8_diff_dior | CREATE UNIQUE INDEX pk_o_8_diff_dior ON reference.o_8_diff_dior USING btree (rid) |
| idx_o_8_diff_dior_rast | CREATE INDEX idx_o_8_diff_dior_rast ON reference.o_8_diff_dior USING gist (st_convexhull(rast)) |
| enforce_spatially_unique_o_8_diff_dior_rast | CREATE INDEX enforce_spatially_unique_o_8_diff_dior_rast ON reference.o_8_diff_dior USING btree (((rast)::geometry)) |
