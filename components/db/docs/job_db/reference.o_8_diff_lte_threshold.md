...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| rid | bigint | nextval('reference.o_8_diff_dior_rid_seq'::regclass) | false |  |  |  |
| rast | raster |  | false |  |  |  |
...
| ---- | ---- | ---------- |
| enforce_coverage_tile_o_8_diff_lte_threshold_rast | CHECK | CHECK (COALESCE(st_iscoveragetile(NULL::raster, NULL::raster, 0, 0), ((mod(((st_upperleftx(rast))::numeric - (500000)::numeric), (4096)::numeric) = (0)::numeric) AND (mod(((st_upperlefty(rast))::numeric - (6570000)::numeric), (4096)::numeric) = (0)::numeric)))) |
...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 8, 'reference'::name, 'diff_lte_threshold'::name, 'rast'::name)) |
...
| pk_o_8_diff_lte_threshold | PRIMARY KEY | PRIMARY KEY (rid) |
| enforce_spatially_unique_o_8_diff_lte_threshold_rast | x | EXCLUDE USING btree (((rast)::geometry) WITH =) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| pk_o_8_diff_lte_threshold | CREATE UNIQUE INDEX pk_o_8_diff_lte_threshold ON reference.o_8_diff_lte_threshold USING btree (rid) |
| idx_o_8_diff_lte_threshold_rast | CREATE INDEX idx_o_8_diff_lte_threshold_rast ON reference.o_8_diff_lte_threshold USING gist (st_convexhull(rast)) |
| enforce_spatially_unique_o_8_diff_lte_threshold_rast | CREATE INDEX enforce_spatially_unique_o_8_diff_lte_threshold_rast ON reference.o_8_diff_lte_threshold USING btree (((rast)::geometry)) |
