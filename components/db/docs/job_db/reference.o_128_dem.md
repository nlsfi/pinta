...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| rid | bigint | nextval('reference.o_128_dem_rid_seq'::regclass) | false |  |  |  |
| rast | raster |  | false |  |  |  |
...
| ---- | ---- | ---------- |
| enforce_coverage_tile_o_128_dem_rast | CHECK | CHECK (COALESCE(st_iscoveragetile(NULL::raster, NULL::raster, 0, 0), ((mod(((st_upperleftx(rast))::numeric - (500000)::numeric), (65536)::numeric) = (0)::numeric) AND (mod(((st_upperlefty(rast))::numeric - (6570000)::numeric), (65536)::numeric) = (0)::numeric)))) |
...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 128, 'reference'::name, 'dem'::name, 'rast'::name)) |
...
| pk_o_128_dem | PRIMARY KEY | PRIMARY KEY (rid) |
| enforce_spatially_unique_o_128_dem_rast | x | EXCLUDE USING btree (((rast)::geometry) WITH =) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| pk_o_128_dem | CREATE UNIQUE INDEX pk_o_128_dem ON reference.o_128_dem USING btree (rid) |
| idx_o_128_dem_rast | CREATE INDEX idx_o_128_dem_rast ON reference.o_128_dem USING gist (st_convexhull(rast)) |
| enforce_spatially_unique_o_128_dem_rast | CREATE INDEX enforce_spatially_unique_o_128_dem_rast ON reference.o_128_dem USING btree (((rast)::geometry)) |
