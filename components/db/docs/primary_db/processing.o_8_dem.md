...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 8, 'processing'::name, 'dem'::name, 'rast'::name)) |
...
| o_8_dem_rast_idx | CREATE INDEX o_8_dem_rast_idx ON processing.o_8_dem USING gist (st_envelope(rast)) |
