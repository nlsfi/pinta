...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 128, 'processing'::name, 'dem'::name, 'rast'::name)) |
...
| o_128_dem_rast_idx | CREATE INDEX o_128_dem_rast_idx ON processing.o_128_dem USING gist (st_envelope(rast)) |
