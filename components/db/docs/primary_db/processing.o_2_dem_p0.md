...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| rid | integer | nextval('processing.o_2_dem_p0_rid_seq'::regclass) | false |  |  |  |
| rast | raster |  | true |  |  |  |
...
| o_2_dem_p0_pkey | PRIMARY KEY | PRIMARY KEY (rid) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| o_2_dem_p0_pkey | CREATE UNIQUE INDEX o_2_dem_p0_pkey ON processing.o_2_dem_p0 USING btree (rid) |
