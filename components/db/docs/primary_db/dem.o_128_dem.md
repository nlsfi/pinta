...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| rid | bigint | nextval('dem.o_128_dem_rid_seq'::regclass) | false |  |  |  |
| rast | raster |  | false |  |  |  |
...
| enforce_overview_rast | CHECK | CHECK (_overview_constraint(rast, 128, 'dem'::name, 'dem'::name, 'rast'::name)) |
...
| Name | Definition |
| ---- | ---------- |
| pk_o_128_dem | CREATE UNIQUE INDEX pk_o_128_dem ON dem.o_128_dem USING btree (rid) |
| idx_o_128_dem_rast | CREATE INDEX idx_o_128_dem_rast ON dem.o_128_dem USING gist (st_convexhull(rast)) |
| enforce_spatially_unique_o_128_dem_rast | CREATE INDEX enforce_spatially_unique_o_128_dem_rast ON dem.o_128_dem USING btree (((rast)::geometry)) |
