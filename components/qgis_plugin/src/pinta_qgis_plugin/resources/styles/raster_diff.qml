...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" layerType="Raster" maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" version="4.0.3-Norrköping">
  <flags>
  ...
  <elevation band="1" enabled="1" mode="RepresentsElevationSurface" symbology="Line" zoffset="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="line">
        ...
        <layer class="SimpleLine" enabled="1" id="{a2cd2cd3-0c75-4493-bb37-139da9ed1510}" locked="0" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{cfa6736c-2cd3-4669-be4f-cf14aef5ca6e}" locked="0" pass="0">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" band="1" classificationMax="1" classificationMin="-1" nodataColor="" opacity="1" type="singlebandpseudocolor">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
        ...
        <cumulativeCutUpper>0.01</cumulativeCutUpper>
  ...
  <originalStyle>
    <maplayer autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" legendPlaceholderImage="" maxScale="0" minScale="1e+08" refreshOnNotifyEnabled="0" refreshOnNotifyMessage="" styleCategories="AllStyleCategories" type="raster">
      ...
      <wgs84extent>
        <xmin>24.39608299291327498</xmin>
        <ymin>61.01797858554687792</ymin>
        <xmax>25.45602336876318006</xmax>
        <ymax>61.53603681314010032</ymax>
      </wgs84extent>
      <id>demm_diff_new_d9f09f4c_a23d_4040_9ba6_af785a2182fc</id>
      <datasource>./demm_diff_new.tif</datasource>
      <layername>demm_diff KM-2025</layername>
      <srs>
      ...
      <map-layer-style-manager current="oletus">
        <map-layer-style name="oletus"/>
            ...
            <colorrampshader classificationMode="1" clip="0" colorRampType="INTERPOLATED" labelPrecision="4" maximumValue="1" minimumValue="-1">
              <colorramp name="[source]" type="gradient">
                <Option type="Map">
                  ...
                  <Option name="rampType" type="QString" value="gradient"/>
                  <Option name="spec" type="QString" value="rgb"/>
                  <Option name="stops" type="QString" value="0.0005;95,173,114,255,hsv:0.37505555555555553,0.45423056382085908,0.67931639581902803,1;rgb;ccw:0.25;182,255,195,255,hsv:0.36283333333333334,0.28621347371633477,1,1;rgb;ccw:0.5;255,255,216,255,rgb:1,1,0.8470588,1;rgb;ccw:0.75;255,255,149,255,rgb:1,1,0.5843137,1;rgb;ccw:0.9995;199,152,0,255,rgb:0.7793088,0.5966735,0,1;rgb;ccw"/>
                </Option>
              </colorramp>
              <item alpha="255" color="#2b83ba" label="-1,0000" value="-1"/>
              <item alpha="255" color="#5fad72" label="-0,9990" value="-0.999"/>
